...
more /usr/local/omk/conf/opCommon.nmis | grep "timezone"
...
declare -a ARRAY=( "mongod " "nmisd" "httpd" "opchartsd" "opeventsd" "opconfigd" "opflowd " "crond" "snmpd" "iptables" )
...
echo -ne "\n$(greenprint 'searching in /nmis8/admin/ ') \n"
cd /usr/local/nmis8/admin; ls -lst | head

echo -ne "\n$(greenprint 'searching in /nmis8/bin/ ') \n"
cd /usr/local/nmis8/bin; ls -lst | head

echo -ne "\n$(greenprint 'searching in /nmis8/cgi-bin/ ') \n"
cd /usr/local/nmis8/cgi-bin; ls -lst | head

echo -ne "\n$(greenprint 'searching in /nmis8/conf/ ') \n"
cd /usr/local/nmis8/conf; ls -lst | head

echo -ne "\n$(greenprint 'searching in /nmis8/models/ ') \n"
cd /usr/local/nmis8/models; ls -lst | head

echo -ne "\n$(greenprint 'searching in /nmis8/lib/ ') \n"
cd /usr/local/nmis8/lib; ls -lst | head
...
cmd_polling_summary=`perl /usr/local/nmis8/admin/polling_summary.pl`
cmd_pg_summary=`perl /usr/local/nmis8/admin/polling_summary.pl > /root/polling_summary_1_$(hostname)`
...
more /usr/local/omk/conf/opCommon.nmis | grep "timezone" >> $dir1/Systemdate.txt
...
perl /usr/local/nmis8/admin/polling_summary.pl > $dir1/polling_summary.txt
...
perl /usr/local/nmis8/admin/fixperms.pl > /dev/null
...
░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
░░ ┌───────────────────────────────────────────────────────────────┐ ░░
░░ │               Troubleshooting Wizard NMIS8 OPMANTEK           │ ░░
